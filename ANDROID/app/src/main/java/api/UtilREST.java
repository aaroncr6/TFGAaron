...
public class UtilREST {
    ...
    private static class PrvDownloadTask extends AsyncTask<Request, Void, Response> {
        ...
        protected void onPostExecute(Response response) {
            if(response.responseCode == HttpURLConnection.HTTP_OK || response.responseCode == 201 || response.responseCode == HttpURLConnection.HTTP_NO_CONTENT)  // Algunas APIs devuelven 201 cuando se añade correctamente
